...
$otherPost = $postscontroller->articleByCategory($category->id,true,$posts->id);
//debug($otherPost);
/*for($i=0;$i <(int)round(sizeof($otherPost)/3);$i++){
var_dump($i);
}
$test=[
    'sizeof'=>sizeof($otherPost),
    'index'=>(int)round(sizeof($otherPost)/3)
];
debug($test);*/
?>
<!DOCTYPE html>
                                ...
                                <div class="row">
                                    ...
                                    <?php for($i=0;$i <2;$i++): ?>
                                        ...
                                        <div class="col-lg-6 col-md-12 d-flex align-items-center justify-content-center">
                                            ...
                                            <img src="<?= $Path.$otherPost[$i]->link ?>" class="img-fluid px-4" alt=""
                                ...
                                <div class="row">
                                    <?php for($i=0;$i <2;$i++): ?>
                                        ...
                                        <div class="col-lg-6 col-md-12 d-flex align-items-center justify-content-center">
                                            ...
                                            <img src="<?= $Path.$otherPost[$i+2]->link ?>" class="img-fluid px-4" alt=""
                                                 style="max-height: 100px;">
                                ...
                                <div class="row">
                                    ...
                                    <?php for($i=sizeof($otherPost);$i>sizeof($otherPost)-2;$i--): ?>
                                        ...
                                        <div class="col-lg-6 col-md-12 d-flex align-items-center justify-content-center">
                                            ...
                                            <img src="<?= $Path.$otherPost[$i-1]->link ?>" class="img-fluid px-4" alt=""
                                                 style="max-height: 100px">
            ...
            <div class="card mb-4 wow fadeIn">
              ...
              <div class="card-body">
                ...
                <div class="media d-block d-md-flex mt-3">
                  <img class="d-flex mb-3 mx-auto z-depth-1" src="assets/img/g-7.jpg"
            ...
            <div class="card card-comments mb-3 wow fadeIn">
              ...
              <div class="card-body">
                ...
                <div class="media d-block d-md-flex mt-4">
                  <img class="d-flex mb-3 mx-auto " src="assets/img/g-8.jpg" alt="Generic placeholder image">
                  <div class="media-body text-center text-md-left ml-md-3 ml-0">
                    ...
                    <div class="media d-block d-md-flex mt-3">
                      <img class="d-flex mb-3 mx-auto " src="assets/img/g-9.jpg"
                    ...
                    <!-- Quick Reply -->
                    <div class="form-group mt-4 replyForm">
                    ...
                    <div class="media d-block d-md-flex mt-3">
                      <img class="d-flex mb-3 mx-auto " src="assets/img/g-10.jpg"
                        alt="Generic placeholder image">
                      <div class="media-body text-center text-md-left ml-md-3 ml-0">
                ...
                <div class="media d-block d-md-flex mt-3">
                  <img class="d-flex mb-3 mx-auto " src="assets/img/g-11.jpg" alt="Generic placeholder image">
                  <div class="media-body text-center text-md-left ml-md-3 ml-0">
                    <h5 class="mt-0 font-weight-bold">Caroline Horwitz
                      <a href="" class="pull-right">
                        <i class="fas fa-reply"></i>
              ...
              <div class="card-body">
                ...
                <form>
                  ...
                  <div class="text-center mt-4">
                    <button class="btn btn-info btn-md" type="submit">Post <i class="fab fa-envelope-o"></i></button>
                  </div>
                </form>
                <!-- Default form reply -->
            ...
            <div class="card mb-4 text-center wow fadeIn">
              ...
              <div class="card-body">
                ...
                <form>
                  ...
                  <div class="text-center mt-4">
                    <button class="btn btn-info btn-md"   type="button">Sign up <i class="fas fa-envelope ml-2"> </i></button>
                  </div>
                </form>
                <!-- Default form login -->
            ...
            <div class="card mb-4 wow fadeIn">
              ...
              <div class="card-body">
                ...
                <ul class="list-unstyled">
                  <li class="media">
                    <img class="d-flex mr-3 img-fluid" style="height: 100px" src="assets/img/horror-5.jpg" alt="Generic placeholder image">
                  ...
                  <li class="media my-4">
                    <img class="d-flex mr-3 img-fluid" style="height: 100px" src="assets/img/nat-3.jpg" alt="An image">
                    <div class="media-body">
                      <a href="">
                        <h5 class="mt-0 mb-1 font-weight-bold">List-based media object</h5>
                      </a>
                  ...
                  <li class="media">
                    <img class="d-flex mr-3 img-fluid" src="assets/img/nature-1.jpg" style="height: 100px" alt="Generic placeholder image">
                    <div class="media-body">
                      <a href="">
                        <h5 class="mt-0 mb-1 font-weight-bold">List-based media object</h5>
                      </a>
